# -*- coding: utf-8 -*-
"""
Created on Mon Mar 16 16:55:01 2026

This script is for creating pseudosections of wendelsheim raw data.
The input file is 20250625_wendelshein_promys.xlsx
This code can be also used for DD and MG separately. 
